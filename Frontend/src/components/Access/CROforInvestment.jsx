    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box sx={{minWidth:"70%",margin:2,overflow:'auto' ,borderRadius:3 }}><Toolbar sx={{ background: `${colors.blueAccent[600]}` }}>
            <TextField
              variant="standard"
              value={searchval}
            ...
            <TableContainer component={Paper} sx={{  maxWidth: "100%", overflow: 'auto',borderRadius:0 }}>
